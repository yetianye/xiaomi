			...
			<div class='content_bot'>
				<ul>
					<li v-for='(item,index) in contents'>
						<goods-content-slide :contents='item'></goods-content-slide>
					</li>
				</ul>
			</div>
		</div>
...
<script>
import goodsContentSlide from './goods_content_slide.vue'
export default{
	name:'goods_content',
	components:{
