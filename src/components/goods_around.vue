	...
	export default{
		...
		data(){
			return{
				...
				goods:[],
			    type:[
			    	{name: '热门', id: 'hot',url:'javascript:;'},
					{name: '服装', id: 'clothes',url:'javascript:;'},
					{name: '米兔', id: 'rabbit',url:'javascript:;'},
					{name: '生活周边', id: 'around',url:'javascript:;'},
					{name: '箱包', id: 'bags',url:'javascript:;'}
			    ],
			    leftgoods: [
